  ...
  render(){
    return(
      <div className={`${styles.personWrap}`}>
        <Header />
        <Person name={this.state.persons[0].name} description={this.state.persons[0].description} />
        <Person name={this.state.persons[1].name} description={this.state.persons[1].description} />
        <Person name={this.state.persons[2].name} description={this.state.persons[2].description} />
        <button onClick={this.descriptionHandler} className={`${styles.buttonPrimary}`}>View Full Description</button>
      </div>
    );
  }
